...
/***/ function(module, exports, __webpack_require__) {
	...
	var crudEvents = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreate = function onCreate(event) {
	  ...
	  api.create(data).then(ui.createSuccess).then(onIndex).catch(ui.createFailure);
	};
	...
	var onUpdate = function onUpdate(event) {
	  ...
	  var id = $(event.target).data('climb');
	  var userInput = getFormFields(event.target);

	  api.update(userInput, id).then(ui.updateSuccess(id)).then(onIndex).catch(ui.updateFailure);
	};
	...
	var onDestroy = function onDestroy(event) {
	  ...
	  api.destroy(id).then(ui.destroySuccess(id)).then(onIndex).catch(ui.destroyFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexClimbsHandlerbars = __webpack_require__(15);
	...
	var indexSuccess = function indexSuccess(data) {
	  ...
	  // table
	  var indexClimbsHtml = indexClimbsHandlerbars({
	    climbs: data.climbs
	  });
	  $('.index').html(indexClimbsHtml);
	};
	...
	var updateSuccess = function updateSuccess(id) {
	...
	var destroySuccess = function destroySuccess(id) {
	  // console.log(pass);
	  $('.destroyClimbModal' + id).modal('toggle');
	  $('.modal-backdrop').remove();
	};

	var destroyFailure = function destroyFailure() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr data-id=\""
	    ...
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.grade : stack1), depth0))
	    + "</td>\n      <td><button  data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#updateClimbModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-edit\" aria-hidden=\"true\"></span></button>\n      <div id=\"updateClimbModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"createClimbModalLabel\">\n        <div class=\"modal-dialog\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n              <h4 class=\"modal-title\" id=\"createClimbModalLabel\">Update Climb</h4>\n            </div>\n            <form class=\"update-climb\"  data-climb=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n              <fieldset>\n                <br>\n                <input class=\"clear-input-update\" type=\"date\" name=\"climb[date]\"><br><br>\n                <select  class=\"btn btn-secondary dropdown-toggle\" type=\"button\" name=\"climb[grade]\"  id=\"dropdownMenuButtonUpdate\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\n                  <option value = \""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.grade : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.grade : stack1), depth0))
	    + "</option>\n                  <option value = \"V0\">V0</option>\n                  <option value = \"V1\">V1</option>\n                  <option value = \"V2\">V2</option>\n                  <option value = \"V2+\">V2+</option>\n                  <option value = \"V3-\">V3-</option>\n                  <option value = \"V3\">V3</option>\n                  <option value = \"V3+\">V3+</option>\n                  <option value = \"V4-\">V4-</option>\n                  <option value = \"V4\">V4</option>\n                  <option value = \"V4+\">V4+</option>\n                  <option value = \"V5-\">V5-</option>\n                  <option value = \"V5\">V5</option>\n                  <option value = \"V5+\">V5+</option>\n                  <option value = \"V6-\">V6-</option>\n                  <option value = \"V6\">V6</option>\n                  <option value = \"V6+\">V6+</option>\n                  <option value = \"V7-\">V7-</option>\n                  <option value = \"V7\">V7</option>\n                  <option value = \"V7+\">V7+</option>\n                  <option value = \"V8-\">V8-</option>\n                  <option value = \"V8\">V8</option>\n                  <option value = \"V8+\">V8+</option>\n                  <option value = \"V9-\">V9-</option>\n                  <option value = \"V9\">V9</option>\n                  <option value = \"V9+\">V9+</option>\n                  <option value = \"V10-\">V10-</option>\n                  <option value = \"V10\">V10</option>\n                  <option value = \"V10+\">V10+</option>\n                  <option value = \"V11-\">V11-</option>\n                  <option value = \"V11\">V11</option>\n                  <option value = \"V11+\">V11+</option>\n                  <option value = \"V12-\">V12-</option>\n                  <option value = \"V12\">V12</option>\n                  <option value = \"V12+\">V12+</option>\n                  <option value = \"V13-\">V13-</option>\n                  <option value = \"V13\">V13</option>\n                  <option value = \"V13+\">V13+</option>\n                  <option value = \"V14-\">V14-</option>\n                  <option value = \"V14\">V14</option>\n                  <option value = \"V14+\">V14+</option>\n                  <option value = \"V15-\">V15-</option>\n                  <option value = \"V15\">V15</option>\n                  <option value = \"V15+\">V15+</option>\n                  <option value = \"V16-\">V16-</option>\n                  <option value = \"V16\">V16</option>\n                  <option value = \"V16+\">V16+</option>\n                </select>\n                <br>\n                <br>\n                <div class=\"modal-footer\">\n                  <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n                  <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn update btn-primary\" name=\"submit\" value=\"Submit\">\n                </div>\n              </fieldset>\n            </form>\n          </div>\n        </div>\n      </div>\n</td>\n      <td><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#destroyClimbModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span></button>\n        <div id=\"destroyClimbModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"destroyClimbModalLabel\">\n          <div class=\"modal-dialog\" role=\"document\">\n            <div class=\"modal-content\">\n              <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                <h4 class=\"modal-title\" id=\"destroyClimbModalLabel\">Are you sure?</h4>\n              </div>\n              <div>\n                <br>\n                <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">No</button>\n                <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn destroy btn-primary\" name=\"submit\" value=\"Yes\"><br><br>\n              </div>\n            </div>\n          </div>\n        </div>\n      </td>\n    </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<table class=\"table table-striped\">\n\n<tbody class=\"scroll-table\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.climbs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</tbody>\n</table>\n";
